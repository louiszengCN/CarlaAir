...
export OSM2ODR_BRANCH=aaron/defaultsidewalkwidth
export OSM2ODR_REPO=https://github.com/carla-simulator/sumo.git
...
if ${BUILD_OSM2ODR} ; then
  ...
  cd "${OSM2ODR_BUILD_FOLDER}" || exit 1
  ...
  cd "${OSM2ODR_SERVER_BUILD_FOLDER}" || exit 1

  # shellcheck disable=SC2034  # LLVM_BASENAME reserved for future use
