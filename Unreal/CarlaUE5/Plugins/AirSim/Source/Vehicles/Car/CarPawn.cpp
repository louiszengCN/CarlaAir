...
UChaosWheeledVehicleMovementComponent* ACarPawn::getVehicleMovementComponent() const
{
...
void ACarPawn::Tick(float Delta)
{
    ...
    if (UChaosWheeledVehicleMovementComponent* movement = getVehicleMovementComponent()) {
