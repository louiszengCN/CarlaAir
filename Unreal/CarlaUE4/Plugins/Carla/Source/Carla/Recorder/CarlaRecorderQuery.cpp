...
inline bool CarlaRecorderQuery::CheckFileInfo(std::stringstream &Info)
{
  ...
  {
    Info << "File is not a CARLA recorder" << '\n';
    return false;
  }

  // show general Info
  Info << "Version: " << RecInfo.Version << '\n';
  Info << "Map: " << TCHAR_TO_UTF8(*RecInfo.Mapfile) << '\n';
    ...
    switch (Header.Id)
    {
      ...
      case static_cast<char>(CarlaRecorderPacketId::EventAdd):
        ...
        for (i = 0; i < Total; ++i)
        {
          ...
          {
            Info << "  " << TCHAR_TO_UTF8(*Att.Id) << " = " << TCHAR_TO_UTF8(*Att.Value) << '\n';
          }
        }
        break;
      ...
      case static_cast<char>(CarlaRecorderPacketId::Position):
        if (bShowAll)
        {
          ...
          Info << " Positions: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
            Position.Read(File);
            Info << "  Id: " << Position.DatabaseId << " Location: (" << Position.Location.X << ", " << Position.Location.Y << ", " << Position.Location.Z << ") Rotation: (" <<  Position.Rotation.X << ", " << Position.Rotation.Y << ", " << Position.Rotation.Z << ")" << '\n';
          }
        }
        else
          SkipPacket();
      ...
      case static_cast<char>(CarlaRecorderPacketId::State):
        if (bShowAll)
        {
          ...
          Info << " State traffic lights: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
      ...
      case static_cast<char>(CarlaRecorderPacketId::AnimVehicle):
        if (bShowAll)
        {
          ...
          Info << " Vehicle animations: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
            Vehicle.Read(File);
            Info << "  Id: " << Vehicle.DatabaseId << " Steering: " << Vehicle.Steering << " Throttle: " << Vehicle.Throttle << " Brake: " << Vehicle.Brake << " Handbrake: " << Vehicle.bHandbrake << " Gear: " << Vehicle.Gear << '\n';
          }
        }
        else
          SkipPacket();
      ...
      case static_cast<char>(CarlaRecorderPacketId::AnimWalker):
        if (bShowAll)
        {
          ...
          Info << " Walker animations: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
            Walker.Read(File);
            Info << "  Id: " << Walker.DatabaseId << " speed: " << Walker.Speed << '\n';
          }
        }
        else
          SkipPacket();
      ...
      case static_cast<char>(CarlaRecorderPacketId::VehicleDoor):
        if (bShowAll)
        {
          ...
          Info << " Vehicle door animations: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
            ...
            Info << "  Id: " << DoorVehicle.DatabaseId << '\n'; 
            Info << "  Doors opened: "; 
      ...
      case static_cast<char>(CarlaRecorderPacketId::VehicleLight):
        if (bShowAll)
        {
          ...
          Info << " Vehicle light animations: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
            ...
            if (enabled_lights_list.size())
            {
              Info << "  Id: " << LightVehicle.DatabaseId << " " <<
                  enabled_lights_list.substr(0, enabled_lights_list.size() - 1) << '\n';
            }
            else
            {
              Info << "  Id: " << LightVehicle.DatabaseId << " None" << '\n';
            }
          }
        }
        else
      ...
      case static_cast<char>(CarlaRecorderPacketId::SceneLight):
        if (bShowAll)
        {
          ...
          Info << " Scene light changes: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
      ...
      case static_cast<char>(CarlaRecorderPacketId::BoundingBox):
        if (bShowAll)
        {
          ...
          Info << " Actor bounding boxes: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
      ...
      case static_cast<char>(CarlaRecorderPacketId::TriggerVolume):
        if (bShowAll)
        {
          ...
          Info << " Actor trigger volumes: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
            ActorBoundingBox.Read(File);
            Info << "  Id: " << ActorBoundingBox.DatabaseId << " origin: ("
      ...
      case static_cast<char>(CarlaRecorderPacketId::PlatformTime):
        if (bShowAll)
        {
          ...
          Info << " Current platform time: " << PlatformTime.Time << '\n';
        }
        else
          SkipPacket();
        break;
        ...
        if (bShowAll)
        {
          ...
          for (i = 0; i < Total; ++i)
          {
            ...
            Info << "  Id: " << PhysicsControl.DatabaseId << '\n'
                ...
                << "   use_gear_auto_box = " << (Control.use_gear_autobox ? "true" : "false") << '\n'
      ...
      case static_cast<char>(CarlaRecorderPacketId::TrafficLightTime):
        if (bShowAll)
        {
          ...
          Info << " Traffic Light time events: " << Total << '\n';
          for (i = 0; i < Total; ++i)
          {
